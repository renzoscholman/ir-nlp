...
def logistic_regression(data, target, folds, penalty='none'):
    # clf = LogisticRegression(multi_class="ovr", penalty=penalty)
...
def grid_search_bow(data, target, ids, questionmark_features, folds=5, do_custom_folds=True):
    ngram_range = [(1, 1), (1, 2)]
